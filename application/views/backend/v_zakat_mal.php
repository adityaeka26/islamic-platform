...
?>
        ...
        <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Masukkan Data Zakat Mal</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Zakat</a></li>
                        <li class="breadcrumb-item active">Masukkan Data Zakat Mal</li>
                    </ol>
                </div>
            </div>
                            ...
                            <div class="card-body">
                                <form action="<?php echo base_url(). 'admin/zakat/exec_add/'; ?>" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="hidden" name="category-zakat" value="Zakat Mal">
                                            <input type="number" name="number-zakat" class="form-control input-default " placeholder="500000">
                                        </div>
                                    </div>
                                    <div class="form-group">
